...
Funcionalidade: Realizar o fluxo End to End
    ...
    Eu como usuario 
    Quero realizar o cadastro e fazer uma compra
    ...
    Cenario: Fluxo End to End de uma compra no site Magnolia
        ...
        E busco pelo produto "Malhado Simples ocasional" no campo de busca e seleciono o produto e adiciono no carrinho
